    ...
    <nav class="navbar navbar-expand-lg navbar-light nav-blur">
        <div class="container">
            ...
            <div class="order-lg-last flex-shrink-0">
                <a class="btn btn-success-light" href="../auth/login.php">Masuk </a>
                <a class="btn btn-light" href="../auth/register.php">Daftar </a>
    ...
    <aside class="col-xl-6 d-lg-none d-sm-block">
        <div class="card p-3 nav-blur">
            <nav class="nav nav-pills mx-auto">
                <a class="nav-link active" aria-current="page" href="../users/index.php">Beranda</a>
                <a class="nav-link" href="../users/tentang.php">Tentang</a>
            </nav>
    </aside>
</div>
