            ...
            <div class="col-8">
                <form action="" method="POST" autocomplete="off">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="npm" name="npm" required maxlength="9" minlength="9" style="width: 150px;" autofocus value="<?= $mhs['npm']; ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" name="ubah" class="btn btn-primary">Tambah Data Mahasiswa</button>
                </form>
            </div>
        </div>
